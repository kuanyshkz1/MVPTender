...
void main() {
  ...
  testWidgets('WelcomeScreen изначально отображает первую страницу', (WidgetTester tester) async {
    await tester.pumpWidget(createTestWidget());

    expect(find.text('Все тендеры Казахстана\nв одном кармане'), findsOneWidget);
    expect(find.text('Далее'), findsOneWidget);
    expect(find.text('Пропустить'), findsOneWidget);
  });

  testWidgets('WelcomeScreen переходит на следующую страницу при нажатии на "Далее"', (WidgetTester tester) async {
    await tester.pumpWidget(createTestWidget());
  ...
  testWidgets('WelcomeScreen завершает онбординг и переходит на /home при нажатии "Пропустить"', (WidgetTester tester) async {
    await tester.pumpWidget(createTestWidget());

    await tester.tap(find.text('Пропустить'));
    await tester.pumpAndSettle();

    // Проверяем переход на замоканный главный экран
  ...
  testWidgets('WelcomeScreen завершает онбординг и переходит на /home на последней странице', (WidgetTester tester) async {
    await tester.pumpWidget(createTestWidget());
